...
class SuperBizAgentApp {
    ...
    updateUI() {
        ...
        if (this.messageInput) {
            ...
            this.messageInput.placeholder = '问问Fan Viewer助手';
        }
    }
        ...
        if (type === 'assistant') {
            ...
            messageAvatar.innerHTML = `
                <svg width="20" height="20" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                    <path d="M776.2 372.8v399.9H248V372.8h528.2m120-120H128v639.9h768.1V252.8h0.1z" fill="white"/>
                    <path d="M379.7 503.4c-38.3 0-69.4 31.1-69.4 69.4s31.1 69.4 69.4 69.4c38.3 0 69.4-31.1 69.4-69.4s-31.1-69.4-69.4-69.4zM645.1 503.4c-38.3 0-69.4 31.1-69.4 69.4s31.1 69.4 69.4 69.4 69.4-31.1 69.4-69.4-31.1-69.4-69.4-69.4zM287.6 97h449v100h-449zM63.3 522.8H192v100H63.3zM831.2 522.8h129.1v100H831.2z" fill="white"/>
                    <path d="M453 139h120v178.6H453z" fill="white"/>
                </svg>
            `;
...
function setupSidebarToggle() {
    ...
    const openSidebar = () => {
        ...
        toggle.setAttribute('aria-label', '关闭侧栏菜单');
        document.body.style.overflow = 'hidden';
    };
    ...
    const closeSidebar = () => {
        ...
        toggle.setAttribute('aria-label', '打开侧栏菜单');
        document.body.style.overflow = '';
    };
